  ...
  render() {
    return (
      ...
      {(this.props.modalType=='create')?(
        < >
        <button className="btn btn-primary mr-4" onClick={this.toggleModal}>Add New Client</button>
        <Modal title={this.props.title} show={this.state.isOpen} onClose={this.toggleModal}>
           <CreateClient onClose={this.toggleModal} />
        </Modal>
        </ >
      ):('')}
      ...
      {(this.props.modalType=='show')?(
        ...
        <Modal id={this.props.id} title={this.props.title} show={this.state.isOpen} onClose={this.toggleModal}>
           <ShowClient id={this.props.id} onClose={this.toggleModal} />
        </Modal>
        </ >
      ):('')}
      ...
      {(this.props.modalType=='edit')?(
        ...
        <Modal id={this.props.id} title={this.props.title} show={this.state.isOpen} onClose={this.toggleModal}>
           <EditClient id={this.props.id} onClose={this.toggleModal} />
        </Modal>
        </ >
      ):('')}
